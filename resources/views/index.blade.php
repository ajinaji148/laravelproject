...
@section('content')
		<div class="banner" bg-danger>
			...
			<div class="container " >
			<img src="images/scope10.jpg" class="w-25 h-auto" alt="Custom-sized image" >
						...
						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							...
							<div class="box-body" itemprop="description">
								<section itemprop="time">
									<p><span>Duration:</span> 3 Months</p>
									<p><span>Class Time:</span> 9am-12am / 2pm-6pm</p>
									<p><span>Fee:</span> 35000</p>
								</section>
							</div>
						</div>
...
This is how SCOPE INDIA can support both newbies and experienced in the industry to upgrade their skills.</p>
		...
		<section class="query-section">
			<div class="container">
				<p><a href="tel:+917592939481"><i class="fas fa-phone"></i> +917592939481(TVM)</a>
				<a href="tel:+918075536185"><i class="fas fa-phone"></i> +918075536185(EKM)</a>
				<a href="tel:+919745936073"><i class="fas fa-phone"></i> +919745936073(NGL)</a></p>
			</div>
		</section>
